...
# cr1 = Repair.create!(car_id: c1.id, cost: 724, service_desc: "Brakes and Shocks");
# cr2 = Repair.create!(car_id: c1.id, cost: 322, service_desc: "Oil change and tire");
# cr3 = Repair.create!(car_id: c2.id, cost: 555, service_desc: "Idler Arm and Alignment");
# cr4 = Repair.create!(car_id: c2.id, cost: 343, service_desc: "Anti-freeze, oil change and wipers");

# puts "Car repairs done";
